...
void FaceCropping(IplImage *img, vector<FaceInfo>& CropFaceSet,vector<IplImage*>& FaceSet, vector<FP>& FaceFP){
	//parameters
	...
	FaceCropper->setParameter("CropConfig.txt"); //get the configs
