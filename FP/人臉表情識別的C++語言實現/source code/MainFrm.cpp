...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext) 
{
	...
	VERIFY(mSplitterWnd.CreateStatic(this,1,2));//创建切分窗口

	VERIFY(mSplitterWnd.CreateView(0,0,RUNTIME_CLASS(CUExpressorView),
		CSize(480,360),pContext));
	VERIFY(mSplitterWnd.CreateView(0,1,RUNTIME_CLASS(SideView),
		CSize(400,360),pContext));
	return true;
}
